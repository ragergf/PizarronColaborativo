var respuestaMaestroForo = {};



respuestaMaestroForo.init = function ()
{
	id = 'id';
	action = 'RespuestaMaestroViewAction';
...
//        console.log('roles:'+rolesUsuario);
	...
	{name:'idPregunta',index:'idPregunta', width:150,editable:false,editrules:{required:false}, editoptions:{size:10}, search: true},	
        ...
        {name:'descRespuesta',index:'descRespuesta', width:150,editable:false,editrules:{required:true}, editoptions:{size:10}, search: true},	
        {name:'calificacion',index:'calificacion', width:150,editable:true,editrules:{required:false}, editoptions:{size:10}, search: true},	
        {name:'comentario',index:'comentario', width:100,editable:true,editrules:{readonly:false}, search: false}
